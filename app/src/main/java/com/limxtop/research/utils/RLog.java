package com.limxtop.research.utils;

import android.util.Log;


import com.limxtop.research.BuildConfig;
 ...
 */
public class RLog {
    private static final String LOG_TAG = "Research";

    private static final String CALLEE_NAME = RLog.class.getCanonicalName();
